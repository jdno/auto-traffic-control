...
require_relative "lib/auto_traffic_control_example/version"

Gem::Specification.new do |spec|
  spec.name = "auto_traffic_control_example"
  spec.version = AutoTrafficControlExample::VERSION
  spec.authors = ["Jan David"]
  spec.email = ["jdno@jdno.dev"]

  spec.summary = "A video game for programmers about air traffic control"
  spec.description = "An example showing how to use the game's API in Ruby"
  spec.homepage = "https://auto-traffic-control.com"
  spec.license = "MIT or Apache-2.0"
  spec.required_ruby_version = ">= 3.0.0"

  # Prevent pushing the example to rubygems.org
